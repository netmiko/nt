...
>
	...
	<xsl:template match="/">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				<title>
					<xsl:choose>
						<xsl:when test="$fileType='Sitemap' or $fileType='RSS'">XSL Sitemap</xsl:when>
		...
		.breadcrumb svg.back {
			...
			<body>
				...
				<xsl:call-template name="Header">
					<xsl:with-param name="title">XSL Sitemap</xsl:with-param>
	...
	<a href="https://netmiko.com"><span>Home</span></a>
	...
	<a href="https://netmiko.com"><span>Home</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="https://netmiko.com/sitemap.xml"><span>Sitemap Index</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
	...
	<div id="content-head">
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on June 25, 2022 at 10:26 am			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="https://netmiko.com"><span>Home</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="https://netmiko.com" class="button">Back to Homepage</a>
					</div>
